...
/// @DnDVersion : 1
/// @DnDHash : 71987FA3
/// @DnDArgument : "code" "/// src_received_buffer(buffer)$(13_10)var buffer=argument[0];$(13_10)var socket=argument[1];$(13_10)var msgId=buffer_read(buffer,buffer_u8);$(13_10)switch(msgId){$(13_10)	case 1:$(13_10)		var clientTime=buffer_read(buffer,buffer_u32);$(13_10)		buffer_seek(global.buffer,buffer_seek_start,0);$(13_10)		//latency=ClientTimelater-clientTime$(13_10)		//msgId=1$(13_10)		buffer_write(global.buffer,buffer_u8, msgId);$(13_10)		buffer_write(global.buffer,buffer_u32,clientTime);$(13_10)		//le devolvemos el ping$(13_10)		network_send_packet(socket,global.buffer,buffer_tell(global.buffer));$(13_10)	break;$(13_10)	//solicitar entrar en cola$(13_10)	case 2:$(13_10)		ds_queue_enqueue(global.cola,socket);$(13_10)		buffer_seek(global.buffer,buffer_seek_start,0);$(13_10)		buffer_write(global.buffer,buffer_u8,msgId);$(13_10)		network_send_packet(socket,global.buffer,buffer_tell(global.buffer));$(13_10)		BuscarPartida();$(13_10)	break;$(13_10)	//sacar de cola y meterlo en partida$(13_10)	case 3:$(13_10)	break;$(13_10)	//sacar de partida al amiguito$(13_10)	case 4:$(13_10)	break;$(13_10)	//Ingresar jugada -or hacer$(13_10)	case 5:$(13_10)		//id de sala$(13_10)		var salapartida=buffer_read(buffer,buffer_u8);$(13_10)		//opcion O$(13_10)		var opcion = buffer_read(buffer,buffer_u8);$(13_10)		//id de caja$(13_10)		var caja=buffer_read(buffer,buffer_u8);$(13_10)		//buscar sala del asociado$(13_10)		salapartida=ds_map_find_value(global.salas,salapartida);$(13_10)		//recibir jugada y registrarla en la sala$(13_10)		if(opcion==0){$(13_10)			salapartida.cajas[caja]="O";$(13_10)		}else{$(13_10)			salapartida.cajas[caja]="X";$(13_10)		}$(13_10)		salapartida.jugadas++;$(13_10)		var resultado;$(13_10)		if(salapartida.cajas[0]=salapartida.cajas[1]&&salapartida.cajas[0]=salapartida.cajas[2]&&(salapartida.cajas[caja]=salapartida.cajas[0])){$(13_10)			//victoria a quien esta enviando$(13_10)			show_debug_message("Erro de igualdad");$(13_10)			resultado=1;$(13_10)		}else{$(13_10)			if(salapartida.cajas[3]=salapartida.cajas[4]&&salapartida.cajas[3]=salapartida.cajas[5]&&(salapartida.cajas[caja]=salapartida.cajas[3])){$(13_10)				//Victoria a quien esta enviando$(13_10)				resultado=1;$(13_10)			}else{$(13_10)				if(salapartida.cajas[6]=salapartida.cajas[7]&&salapartida.cajas[6]=salapartida.cajas[8]&&(salapartida.cajas[caja]=salapartida.cajas[6])){$(13_10)					//Victoria a quien esta enviando$(13_10)					resultado=1;$(13_10)				}else{$(13_10)					if(salapartida.cajas[0]=salapartida.cajas[3]&&salapartida.cajas[0]=salapartida.cajas[6]&&(salapartida.cajas[caja]=salapartida.cajas[0])){$(13_10)						//Victoria a quien esta enviando$(13_10)						resultado=1;$(13_10)					}else{$(13_10)						if(salapartida.cajas[1]=salapartida.cajas[4]&&salapartida.cajas[1]=salapartida.cajas[7]&&(salapartida.cajas[caja]=salapartida.cajas[1])){$(13_10)							//Victoria a quien envia$(13_10)							resultado=1;$(13_10)						}else{$(13_10)							if(salapartida.cajas[2]=salapartida.cajas[5]&&salapartida.cajas[2]=salapartida.cajas[8]&&(salapartida.cajas[caja]=salapartida.cajas[2])){$(13_10)								//Victoria a quien envia$(13_10)								resultado=1;$(13_10)							}else{$(13_10)								if(salapartida.cajas[6]=salapartida.cajas[4]&&salapartida.cajas[6]=salapartida.cajas[2]&&(salapartida.cajas[caja]=salapartida.cajas[6])){$(13_10)									//Victoria a quien envia$(13_10)									resultado=1;$(13_10)								}else{$(13_10)									if(salapartida.cajas[8]=salapartida.cajas[4]&&salapartida.cajas[8]=salapartida.cajas[0]&&(salapartida.cajas[caja]=salapartida.cajas[8])){$(13_10)										//Victoria a quien envia$(13_10)										resultado=1;$(13_10)									}else{$(13_10)										//ninguno de los ganó$(13_10)										if(salapartida.jugadas==9){$(13_10)											resultado=3;$(13_10)											salapartida.partida=false;$(13_10)											//Empate$(13_10)											//enviar fin$(13_10)										}else{$(13_10)											resultado=0;$(13_10)											//enviar nomas$(13_10)										}$(13_10)									}$(13_10)								}$(13_10)							}$(13_10)						}$(13_10)					}$(13_10)				}$(13_10)			}$(13_10)		}$(13_10)		if(salapartida.cajas[caja]="O"){$(13_10)			//scket1 jugó$(13_10)			buffer_seek(global.buffer,buffer_seek_start,0);$(13_10)			buffer_write(global.buffer,buffer_u8,msgId);$(13_10)			buffer_write(global.buffer,buffer_u8,resultado);$(13_10)			buffer_write(global.buffer,buffer_u8,0);$(13_10)			buffer_write(global.buffer,buffer_u8,caja);$(13_10)			network_send_packet(salapartida.scket1,global.buffer,buffer_tell(global.buffer));$(13_10)			buffer_seek(global.buffer,buffer_seek_start,0);$(13_10)			buffer_write(global.buffer,buffer_u8,msgId);$(13_10)			if(resultado==0||resultado==3){$(13_10)			buffer_write(global.buffer,buffer_u8,resultado);}else{$(13_10)				buffer_write(global.buffer,buffer_u8,2);$(13_10)				salapartida.partida=false;$(13_10)			}$(13_10)			buffer_write(global.buffer,buffer_u8,1);$(13_10)			buffer_write(global.buffer,buffer_u8,caja);$(13_10)			show_debug_message("paso por aca bien");$(13_10)			network_send_packet(salapartida.scket2,global.buffer,buffer_tell(global.buffer));$(13_10)		}else{$(13_10)			//scket2 jugó$(13_10)			buffer_seek(global.buffer,buffer_seek_start,0);$(13_10)			buffer_write(global.buffer,buffer_u8,msgId);$(13_10)			if(resultado==0||resultado==3){$(13_10)			buffer_write(global.buffer,buffer_u8,resultado);}else{$(13_10)				buffer_write(global.buffer,buffer_u8,2);salapartida.partida=false;$(13_10)			}$(13_10)			buffer_write(global.buffer,buffer_u8,1);$(13_10)			buffer_write(global.buffer,buffer_u8,caja);$(13_10)			network_send_packet(salapartida.scket1,global.buffer,buffer_tell(global.buffer));$(13_10)			buffer_seek(global.buffer,buffer_seek_start,0);$(13_10)			buffer_write(global.buffer,buffer_u8,msgId);$(13_10)			buffer_write(global.buffer,buffer_u8,resultado);$(13_10)			buffer_write(global.buffer,buffer_u8,0);$(13_10)			buffer_write(global.buffer,buffer_u8,caja);$(13_10)			show_debug_message("paso por aca");$(13_10)			network_send_packet(salapartida.scket2,global.buffer,buffer_tell(global.buffer));$(13_10)		}$(13_10)		//decidir victoria/empate$(13_10)		//enviar jugar o finalizar$(13_10)	break;$(13_10)}"
...
switch(msgId){
	...
	case 5:
		...
		salapartida.jugadas++;
		var resultado;
		if(salapartida.cajas[0]=salapartida.cajas[1]&&salapartida.cajas[0]=salapartida.cajas[2]&&(salapartida.cajas[caja]=salapartida.cajas[0])){
			//victoria a quien esta enviando
			show_debug_message("Erro de igualdad");
			resultado=1;
		}else{
			if(salapartida.cajas[3]=salapartida.cajas[4]&&salapartida.cajas[3]=salapartida.cajas[5]&&(salapartida.cajas[caja]=salapartida.cajas[3])){
				//Victoria a quien esta enviando
				resultado=1;
			}else{
				if(salapartida.cajas[6]=salapartida.cajas[7]&&salapartida.cajas[6]=salapartida.cajas[8]&&(salapartida.cajas[caja]=salapartida.cajas[6])){
					//Victoria a quien esta enviando
					resultado=1;
				}else{
					if(salapartida.cajas[0]=salapartida.cajas[3]&&salapartida.cajas[0]=salapartida.cajas[6]&&(salapartida.cajas[caja]=salapartida.cajas[0])){
						//Victoria a quien esta enviando
						resultado=1;
					}else{
						if(salapartida.cajas[1]=salapartida.cajas[4]&&salapartida.cajas[1]=salapartida.cajas[7]&&(salapartida.cajas[caja]=salapartida.cajas[1])){
							//Victoria a quien envia
							resultado=1;
						}else{
							if(salapartida.cajas[2]=salapartida.cajas[5]&&salapartida.cajas[2]=salapartida.cajas[8]&&(salapartida.cajas[caja]=salapartida.cajas[2])){
								//Victoria a quien envia
								resultado=1;
							}else{
								if(salapartida.cajas[6]=salapartida.cajas[4]&&salapartida.cajas[6]=salapartida.cajas[2]&&(salapartida.cajas[caja]=salapartida.cajas[6])){
									//Victoria a quien envia
									resultado=1;
								}else{
									if(salapartida.cajas[8]=salapartida.cajas[4]&&salapartida.cajas[8]=salapartida.cajas[0]&&(salapartida.cajas[caja]=salapartida.cajas[8])){
										//Victoria a quien envia
										resultado=1;
									}else{
										//ninguno de los ganó
